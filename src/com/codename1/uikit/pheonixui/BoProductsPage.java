...
public class BoProductsPage extends BaseForm {
    EncodedImage enc;
    Image imgs;
    ImageViewer imgv;
    public BoProductsPage() {
        this(com.codename1.ui.util.Resources.getGlobalResources());
    }

    private ArrayList<Product> products = new ArrayList<>();
    private Form current = this;
    public BoProductsPage(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        Container destinationsList = new InfiniteContainer() {
            ...
            public Component[] fetchComponents(int index, int amount) {
                ...
                for(int iter = 0; iter < amount; iter++){
                    ...
                    String url = Statics.BASE_URL+"/uploads/images/"+products.get(offset).getImg();
                    ...
                    MultiButton mb = new MultiButton(products.get(offset).getName());
                    mb.setTextLine2(products.get(offset).getPrice()+" TND");
                    mb.setTextLine3("categorie : "+products.get(offset).getCat());
                    mb.setTextLine4("\n Description : \n" + products.get(offset).getDesignation());
                    ...
                    Button buttonCart = new Button(FontImage.MATERIAL_UPDATE);
                    buttonCart.addActionListener(evt -> {
                        new UpdateProductForm(products.get(offset)).show();
                    });
                    container.add(BorderLayout.NORTH,imgv);
                    container.add(BorderLayout.CENTER,mb);
                    container.add(BorderLayout.SOUTH,buttonCart);
