...
public class RecipesForm extends BaseForm {
    EncodedImage enc;
    Image imgs;
    ImageViewer imgv;
    ...
    public RecipesForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);
        recettes = RecetteService.getInstance().getRecettes();

        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Recettes", "Title"),
                        new Label(String.valueOf(recettes.size()), "InboxNumber")
                )
        );
        ...
        Container destinationsList = new InfiniteContainer() {
            ...
            public Component[] fetchComponents(int index, int amount) {
                ...
                if (index + amount > recettes.size()) {
                    amount = recettes.size() - index;
                ...
                for (int iter = 0; iter < amount; iter++) {
                    ...
                    String url = Statics.BASE_URL + "/uploads/images/" + recettes.get(offset).getPhotoRecette();
                    ...
                    MultiButton mb = new MultiButton(recettes.get(offset).getNomRecette());
                    mb.setTextLine2(recettes.get(offset).getCategorieRecette());
                    mb.setTextLine3("Durée : " + recettes.get(offset).getDureeRecette());
                    mb.setTextLine4("\n Description : \n" + recettes.get(offset).getDescriptionRecette());
                    ...
                    mb.addActionListener(e -> {
                        new UpdateRecetteForm(recettes.get(offset)).show();
                    });
