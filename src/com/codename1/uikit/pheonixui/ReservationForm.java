...
public class ReservationForm extends BaseForm {
    ...
    public ReservationForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        reservations = ReservationService.getInstance().getReservations();

        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Reservations", "Title"),
                        new Label(String.valueOf(reservations.size()), "InboxNumber")
                )
        );
        ...
        Container destinationsList = new InfiniteContainer() {
            ...
            public Component[] fetchComponents(int index, int amount) {
                ...
                if(index + amount > reservations.size()){
                    amount = reservations.size() - index;
                ...
                for(int iter = 0; iter < amount; iter++){
                    ...
                    String url = Statics.BASE_URL+"/uploads/images/"+reservations.get(offset).getImage();
                    ...
                    MultiButton mb = new MultiButton(reservations.get(offset).getNomResto());
                    mb.setTextLine2(reservations.get(offset).getAdresse());
                    mb.setTextLine3(reservations.get(offset).getNbplaceReservation()+" Places.");
                             mb.setTextLine4("\n Date: \n" + reservations.get(offset).getDateReservation());
                    ...
                    mb.addActionListener(e-> {
                        new UpdateReservationForm(reservations.get(offset)).show();
                    });
